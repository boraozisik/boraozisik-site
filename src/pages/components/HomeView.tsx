...
const HomeView = (props: Props) => {
  ...
  return (
    <>
          ...
          <div className="grid items-center grid-cols-1 lg:grid-cols-2 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <a
                ...
                title=""
                className="inline-flex items-center px-6 py-4 mt-8 font-medium text-white transition-all duration-200 bg-[#89ABE3]  rounded-full lg:mt-16 hover:bg-blue-400 focus:bg-blue-400"
                role="button"
              >
                About
                <svg
              ...
              <a
                ...
                title=""
                className="ml-4 inline-flex items-center px-6 py-4 mt-8 font-medium text-black transition-all duration-200 bg-[#EA738D] rounded-full lg:mt-16 hover:bg-red-400 focus:bg-yellow-400"
                role="button"
              >
                My Work
                <svg
      ...
      <section className="text-gray-100 body-font bg-gray-100">
        <div className="container px-5 py-12 mx-auto">
          ...
          <div className="flex items-center lg:w-full mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              <p className="leading-relaxed text-base text-gray-800 font-medium">
          ...
          <div className="flex items-center lg:w-full mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div className="sm:w-20 sm:h-20 sm:order-none order-first h-20 w-20 sm:ml-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
